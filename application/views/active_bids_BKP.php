...
?>
        <div class="main col-xs-12">
          ...
          <ul class="nav navbar-nav section-menu">
            ...
            <li class="active"><a href="../load_stock/active_bids">Your Active Bids<span class="badge"><?php echo $select_query->num_rows;?></span></a></li>
 ...
 $elapsed = '';
		...
		?>
                        <tr>
                            ...
                            <td><?php echo $stat;?></td>
                            <td width="260">
                                <a href="#" onclick="modalshow('<?php echo $row->ass_id; ?>','1')" class="btn btn-default"  >Bid</a>
                              <a href="buynow" class="btn btn-default">Buy Now</a>
                              <a href="#" onclick="modalshow('<?php echo $row->ass_id; ?>','2')"  class="btn btn-default" >Watch List</a>
                            </td>
                        </tr>
                <?php }
...
?>
 ...
 $("#modalwin").load("loadajax?c="+a+"&type="+b);
