    ...
    <div class="page_wrap">
      ...
      <div class="side_bar">
        ...
        <ul>
          ...
          <li>
            <a href="auctions.php" class="active"><span class="glyphicon glyphicon-list-alt"></span>Auctions</a>
            <ul>
              <li><a href="auctions.php">Search</a></li>
              <li><a href="auction_room.php">Active Bids <span class="badge inbox-badge">20</span></a></li>
              <li><a href="auction_room.php">Watch List <span class="badge inbox-badge">8</span></a></li>
              <li><a href="auction_room.php">Won Bids <span class="badge inbox-badge">1</span></a></li>
              <li><a href="auction_room.php">Lost Bids <span class="badge inbox-badge">0</span></a></li>
            </ul>
          </li>
          <li>
