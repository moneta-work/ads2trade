<?php //include("header.php"); ?>
        ...
        <div class="main">
          ...
          <div class="col-xs-4">
            ...
            <div class="panel panel-default">
              ...
              <ul class="list-group">
                 ...
                 <li class="list-group-item"><a href="../my_stock/index"><span class="glyphicon glyphicon-plus"></span>Add Assets to Auction</a></li>
                <li class="list-group-item"><span class="glyphicon glyphicon-plus"></span>Load Stock</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-xs-4">
            <div class="panel panel-default">
              <div class="panel-heading">Incoming Request For Proposals<a href="../new_campaign/mo_proposals" class="label label-default pull-right">View All</a></div>
              <ul class="list-group">
                 <li class="list-group-item"><span class="glyphicon glyphicon-plus"></span>Number Of Items [ 8 ]</li>
                  <li class="list-group-item"><span class="glyphicon glyphicon-plus"></span>Total Value [ R 200,000.00 ]</li>
                  <li class="list-group-item"><span class="glyphicon glyphicon-plus"></span></li>
                 <li class="list-group-item"></li>
                <li class="list-group-item"></li>
              </ul>
            </div>
