        ...
        <div class="main">
          ...
          <div class="col-xs-4">
            <div class="panel panel-default">
              ...
              <ul class="list-group">
                  <li class="list-group-item"><a href="<?php echo site_url();?>auctions"><span class="glyphicon glyphicon-plus"></span>Auctions</a></li>
                  <li class="list-group-item"><a href="<?php echo site_url();?>new_campaign"><span class="glyphicon glyphicon-plus"></span>Build A Campaign</a></li>
                  <li class="list-group-item"><a href="<?php echo site_url();?>buy_now"><span class="glyphicon glyphicon-plus"></span>Buy Now</a></li>
                <li class="list-group-item"><a href="<?php echo site_url();?>rfp"><span class="glyphicon glyphicon-file"></span>Request For Proposal</a></li>
