          ...
          <div class="row">
            <div class="col-xs-8">
              <div id="dashboard_stats">
                <div class="row">
                  <div class="col-sm-4">
                    <a href="../load_stock/view_my_assets" class="stat icon1">
                      ...
                      <div class="row info">
                        ...
                        <div class="col-sm-8 text-right">
                          <small><span>Current Bid Value:</span>R<?php echo $curr_bids;?></small>
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-sm-4">
                     <a href="../load_stock/active_bids" class="stat icon2">
                      ...
                      <div class="row info">
                        ...
                        <div class="col-sm-8 text-right">
                          <small><span>Current Bid Value:</span>R<?php echo $out_bids;?></small>
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <a href="../load_stock/asset_details3" class="stat icon3">
                      <h3><?php echo $select_query2->num_rows;?></h3>
                      <h4>Auctions</h4>
                      <hr>
                      <div class="row info">
                        <div class="col-sm-4 text-left">
                          <small><span>Total:</span>R<?php echo $won_bids;?></small>
                        </div>
                        <div class="col-sm-8 text-right">
                          <small><span>Current Bid Value:</span>R<?php echo $cwon_bids;?></small>
                        </div>
                      </div>
                    </a>
                  </div>
                  ...
                  <div class="col-sm-4">
                    <a href="../new_campaign/mo_proposals" class="stat icon4">
                      <h3><?php echo $select_rfp->num_rows;?></h3>
                  ...
                  <div class="col-sm-4">
                    <a href="../my_stock/index" class="stat icon5">
                      <h3><?php echo $select_query->num_rows;?></h3>
                      <h4>Add Assets To Auction</h4>
                      <hr>
                      <div class="row info">
                        <div class="col-sm-4 text-left">
                          <small><span>Total:</span>R<?php echo $open_bids; ?></small>
                        </div>
                        <div class="col-sm-8 text-right">
                          <small><span>Current Bid Value:</span>R<?php echo $curr_bids;?></small>
                        </div>
                  ...
                  <div class="col-sm-4">
                    <a href="#" class="stat icon6">
                      ...
                      <div class="row info">
                        <div class="col-sm-4 text-left">
                          <small><span>Total:</span>R46,000</small>
                        </div>
                        <div class="col-sm-8 text-right">
                          <small><span>Current Bid Value:</span>R46,000</small>
                        </div>
                      </div>
                    </a>
                  </div>
