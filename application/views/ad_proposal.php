...
<div class="breadcrumbs">
	<h1><span class="glyphicon glyphicon-list-alt"></span>RFP :: My Incoming Proposals</h1>
</div>
...
<div>
	<table class="table table-striped">
		...
		<td>
                ...
                <td><a href="../load_stock/proposal?ass_id=3" class="btn btn-default"  >View this Proposal</a><input type="hidden" name="campaign_desc" id="campaign_desc"
		                                               value="<?php echo $amai->cam_description; ?>"/></td>
	<td><a href="../new_campaign/accept_proposal?id=3" class="btn btn-default"  >Accept this Proposal</a><input type="hidden" name="campaign_desc" id="campaign_desc"
		                                               value="<?php echo $amai->cam_description; ?>"/></td>	
        </tr>
