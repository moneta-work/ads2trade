<?php //include("header.php"); ?>
        <div class="breadcrumbs">
          <h1><span class="glyphicon glyphicon-list-alt"></span>All Watch List</h1>
        </div>
...
?>
        <div class="main col-xs-12">
          ...
          <ul class="nav navbar-nav section-menu">
            ...
            <li class="active"><a href="../load_stock/all_watch_list">All Watch List<span class="badge"><?php echo $select_query1->num_rows;?></span></a></li>
