...
foreach ($mmm as $row) {
    ...
    $dates = $row->ends; //10/17/2014 04:42 PM';
}

?>

<div class="breadcrumbs">
          <h1><span class="glyphicon glyphicon-home"></span>Approve/Decline Asset to Auction</h1>
        </div>
        <div class="main">
...
//    echo form_open_multipart('my_stock/auction', $attributes);
 ...
 <form name="auct" action="../my_stock/approve?p=op_asset" method="post" accept-charset="utf-8" class="form" enctype="multipart/form-data">       
    ...
    <div class="col-sm-6"> 
       ...
       ?>     
        ...
        <div class="wrapper">
            ...
            <br>
            <div id="map_canvas" style="height:350px;width:600px;margin:-2;">
<?php echo $map['html'];?>
</div>
        </div>
...
<div class="bottom-buttons">
    <a href="index" class="btn btn-default">Back</a>
        <?php if ($found == 0){?><input name="approve" type="submit" class="btn btn-primary" value="Approve This">&nbsp;&nbsp;<input name="decline" type="submit" class="btn btn-primary" value="Decline This"><?php }else{ echo 'Item Already On Auction';}?>
