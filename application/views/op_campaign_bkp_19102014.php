...
<div>
	<table class="table table-striped">
		...
		<td><a href="../new_campaign/campaigns1?id=<?php echo $amai->rfp_id; ?>" class="btn btn-default"  >Process This RFP</a><input type="hidden" name="campaign_desc" id="campaign_desc"
