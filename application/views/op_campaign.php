...
<div>
	<table class="table table-striped">
		...
		<td>
                ...
                <td><?php if ($processed <> '1'){ ?><a href="../new_campaign/campaigns1?id=<?php echo $amai->cam_id; ?>" class="btn btn-default"  >Process This RFP</a><?php } ?><input type="hidden" name="campaign_desc" id="campaign_desc"
