...
<div class="breadcrumbs">
    <h1><span class="glyphicon glyphicon-list-alt"></span>Add Items To Auction</h1>
</div>
									...
									<div>
										...
										<div class="row">
											<div class="col-sm-12">
												...
												<span data-bind="visible: !IsComingSoon"><span href="../load_stock/asset_details3" class="label label-primary" data-bind="text:SiteName"></span></span>
												<span><span class="btn btn-primary">Add to Auction</span></span>
                                                                                             </div>
