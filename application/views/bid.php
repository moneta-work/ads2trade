...
<div id='modalwin' >
    <div class="modal-header">
            <label></label><h4 class="modal-title" id="myModalLabel"><label id="ass_name">Thank You</label></h4>
          </div>
    <div class="modal-body">
        <div>You Have Successfully Placed Your Bid, Good Luck</div>
        <br>
        <br>
           <div  class="col-xs-8">
              ...
              <div class="form-group">
                <div class="input-group">
                 <a href="asset_details3"  class="input-group-addon btn btn-primary">Continue Bidding</a>&nbsp;
                 <a href="active_bids"  class="input-group-addon btn btn-primary">Go To My Shopping Basket</a>&nbsp;
                 <a href="../navigate/index"  class="input-group-addon btn btn-primary">Exit Auctions</a>
                </div>
              </div>
