<?php //include("header.php"); ?>
        <div class="breadcrumbs">
          <h1><span class="glyphicon glyphicon-list-alt"></span>Invoice List</h1>
        </div>
...
?>
        <div class="main col-xs-12">
          ...
          <ul class="nav navbar-nav section-menu">
            ...
            <li><a href="../navigate/invoice_list">Outstanding Invoices<span class="badge"><?php echo $select_query->num_rows;?></span></a></li>
            <li class="active"><a href="../navigate/invoice_list">Invoice List<span class="badge"><?php echo $select_query1->num_rows;?></span></a></li>
