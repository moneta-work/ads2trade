...
<div class="breadcrumbs">
	<h1><span class="glyphicon glyphicon-list-alt"></span>RFP ::My Request For Proposals</h1>
</div>
<div class="main col-xs-12">
<form method="post">
	<ul class="nav navbar-nav section-menu">
			<li class="active"><a href="../new_campaign/ad_campaigns">My Outstanding Proposals</a></li>
			<li ><a href="../new_campaign/ad_proposals">Incoming Proposals<span class="badge">1</span></a></li>
			<li><a href="../load_stock/watch_list">Sold Items<span	class="badge">2</span></a></li>
...
<div>
	<table class="table table-striped">
		...
		<td>
                ...
                <td><?php if ($processed <> '1'){ ?><a href="../new_campaign/campaigns1?id=<?php echo $amai->cam_id; ?>" class="btn btn-default"  >Cancel this RFP</a><?php } ?><input type="hidden" name="campaign_desc" id="campaign_desc"
