...
<div id='modalwin' >
    ...
    <div class="modal-body">
        <div>Asset has been placed in your basket, Please note that you have 30min to pay for this asset else it will be removed</div>
        <br>
        <br>
           <div  class="col-xs-8">
              ...
              <div class="form-group">
                <div class="input-group">
                    <a href="<?php echo $p;?>"  class="input-group-addon btn btn-primary">Continue Buying</a>&nbsp;
